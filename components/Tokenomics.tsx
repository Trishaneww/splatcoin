...
const Tokenomics = () => {
  return (
    <div className="flex flex-col items-center gap-2 mt-32 px-6">
        ...
        <p className="text-lg font-bold text-center">Founders Like You. They Buy They Sale Their $PLAT</p>
        <section className="w-full lg:w-[65%] flex flex-col gap-4 px-4 py-6 border-[1px] border-black bg-slate-50 mt-6">
          ...
          <div className="flex flex-col gap-2">
            ...
            <div className="flex flex-col lg:flex-row gap-2">
              ...
              <Button className="h-[50px] px-4 bg-sky-300 border-[1px] border-black text-black">Copy Address</Button>
            </div>
