  ...
  return (
    <div className="flex flex-col items-center gap-12 mt-32">
        ...
        <section className="grid grid-cols-1 md:grid-cols-3 gap-6 px-6 md:w-[80%]">
            <div className="flex flex-col items-center justify-center text-left text-lg gap-6 bg-slate-50 border-[1.5px] border-black rounded-lg w-full max-w-[450px] py-8 px-6">
                <p className="text-2xl lg:text-4xl">CREATE A WALLET</p>
