    ...
    <div className="flex flex-col items-center gap-12 mt-20 lg:mt-32 px-6">
        ...
        <section className="grid grid-cols-1 md:grid-cols-2 gap-6 px-6 w-[88%] md:w-[80%] lg:w-[70%]">
            <div className="flex flex-col items-center justify-start text-base text-left lg:text-lg gap-6 bg-white border-[1px] border-gray-200 rounded-lg w-full py-8 px-6">
                ...
                <p className="text-justify">Set up your Phantom wallet, the ultimate Solana wallet for managing your crypto. It is quick, secure, and easy to use. Head to <Link href="https://phantom.com/" target="_blank" className="text-blue-600">Phantom's website</Link> to get started!</p>
            </div>
            ...
            <div className="flex flex-col items-center justify-start text-base text-left lg:text-lg gap-6 bg-white border-[1px] border-gray-200 rounded-lg w-full py-8 px-6">
                ...
                <p className="text-justify">Purchase Solana (SOL) on your favorite crypto exchange (like Binance or Coinbase). Once you have SOL, send it directly to your Phantom wallet.</p>
            </div>
            ...
            <div className="flex flex-col items-center justify-start text-base text-left lg:text-lg gap-6 bg-white border-[1px] border-gray-200 rounded-lg w-full py-8 px-6">
                ...
                <p className="text-justify">Go to Raydium or Jupiter, trusted Solana-based decentralized exchanges. Connect your Phantom wallet to start trading with ease.</p>
            </div>
            ...
            <div className="flex flex-col items-center justify-start text-base text-left lg:text-lg gap-6 bg-white border-[1px] border-gray-200 rounded-lg w-full py-8 px-6">
                ...
                <p className="text-justify">Use your SOL to swap for $SPLAT on Raydium or Jupiter. Confirm the transaction and watch as $SPLAT lands in your wallet! 🚀</p>
            </div>
        </section>
